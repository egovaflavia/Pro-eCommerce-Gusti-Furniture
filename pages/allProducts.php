    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-md-9 order-2">
                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                        <div class="float-md-left mb-4">
                            <h2 class="text-black h5">All - <span><?= $item ?> ITEM(S)</span></h2>
                        </div>
                        <div class="d-flex">
                ...
                <div class="row mb-5">
                    <?php
                    foreach ($db->getAllProduk() as $row) :
                        // echo '<pre>';
                        // print_r($row);
                        // echo '</pre>';
                        ...
                        <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                <figure class="block-4-image">
                                    <a href="index.php?page=pages/detail&id=<?= $row->produk_id ?>"><img src="cpanel/assets/images/products/<?= $row->produk_gambar ?>" alt="Image placeholder" class="img-fluid"></a>
                                </figure>
