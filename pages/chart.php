							...
							?>
								<tr>
									<td class="product-thumbnail">
										<img src="cpanel/assets/images/products/<?= $dProduk->produk_gambar ?>" width="100" height="100" alt="Image" class="img-fluid">
									</td>
									...
									<td>
										<a href="index.php?page=pages/hapusKeranjang&id=<?= $dProduk->produk_id ?>" class="btn btn-primary btn-sm">X</a></td>
								</tr>
							<?php endforeach ?>
						</tbody>
					</table>
