<?php
$id = $_GET['id'];
$dataKategori = $db->getOneKategori($id);
// var_dump($dataKategori);

if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if ($db->editKategori($_POST) > 0) {
        echo "
            <script>
                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input value="<?= $dataKategori->kategori_id ?>" name="id" type="hidden">
                                        <input value="<?= $dataKategori->kategori_nama ?>" name="nama" type="text" class="form-control" placeholder="Nama Kategori">
                                    </div>
                                </div>
                            </div>
                        </div>
